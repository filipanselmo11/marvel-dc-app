<template>
  <v-card class="mx-auto" max-width="344">
    ...
    <v-card-title>Madame Hidra</v-card-title>
    <v-card-actions>
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Madame Hidra</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
                <strong>Nome Completo</strong>
              </div>
              <div class="mr-n2">Ophelia Sarkissian</div>
              <div class="mr-2 mt-3">
                <strong>Codinomes Conhecidos</strong>
              </div>
              <div class="mr-n2">Madame Hidra, Víbora</div>
              <div class="mr-2 mt-3">
                <strong>Terra Natal</strong>
              </div>
              <div class="mr-n2">Hungria</div>
              <div class="mr-2 mt-3">
                ...
                <v-timeline :dense="$vuetify.breakpoint.smAndDown">
                  <v-timeline-item color="purple lighten-2" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="8">Hidra</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  ...
                  <v-timeline-item color="deep-purple accent-2" fill-dot left small>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10">Esquadrão Serpente</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  <v-timeline-item color="red lighten-5" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10">Clube do Inferno</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
