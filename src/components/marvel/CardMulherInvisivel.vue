<template>
  <v-card class="mx-auto" max-width="344">
    <v-img
      src="../../assets/mulher-invisivel.jpeg"
      max-height="460"
      max-width="400"
    ></v-img>
    <v-card-title>Mulher Invisível</v-card-title>
    <v-card-actions>
      <v-dialog transition="dialog-bottom-transition" max-width="600">
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Mulher Invisível</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
                <strong>Nome Completo</strong>
              </div>
              <div class="mr-n2">Susan Storm</div>
              <div class="mr-2 mt-3">
                <strong>Codinomes Conhecidos</strong>
              </div>
              <div class="mr-n2">
                Baronesa von Doom, Maligna, Garota Invisível, Capitã Universo, Susan "Sue" Storm-Richards
              </div>
              <div class="mr-2 mt-3">
