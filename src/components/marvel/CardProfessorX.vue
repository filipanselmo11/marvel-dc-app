<template>
  <v-card class="mx-auto" max-width="344">
    ...
    <v-card-title>Professor X</v-card-title>
    <v-card-actions>
      <v-dialog transition="dialog-bottom-transition" max-width="600">
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Professor X</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
                <strong>Nome Completo</strong>
              </div>
              <div class="mr-n2">Charles Francis Xavier</div>
              <div class="mr-2 mt-3">
                <strong>Codinomes Conhecidos</strong>
              </div>
              <div class="mr-n2">
                Professor, Pai dos Mutantes, Doutor X, Massacre, Prisioneiro M-13
              </div>
              <div class="mr-2 mt-3">
              ...
              <div class="mr-n2">Humano Mutante</div>
              <div class="mr-2 mt-3">
                ...
                <v-timeline :dense="$vuetify.breakpoint.smAndDown">
                  <v-timeline-item color="purple lighten-2" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="8"> X-Men </v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  ...
                  <v-timeline-item color="amber lighten-1" fill-dot left small>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10"> Império Shiar </v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  ...
                  <v-timeline-item color="cyan lighten-1" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10"> Os Doze </v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  ...
                  <v-timeline-item color="red lighten-1" fill-dot left small>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10"> Excalibur de Genosha </v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
