<template>
  <v-card class="mx-auto" max-width="344">
    <v-img src="../../assets/arqueiro-verde.jpeg" max-height="460" max-width="400"></v-img>
    <v-card-title>Arqueiro Verde</v-card-title>
    <v-card-actions>
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Arqueiro Verde Verde</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
