<template>
  <v-card class="mx-auto" max-width="344">
    <v-img src="../../assets/shazam.jpeg" max-height="460" max-width="400"></v-img>
    <v-card-title>Shazam</v-card-title>
    <v-card-actions>
      <v-dialog transition="dialog-bottom-transition" max-width="600">
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Shazam</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
                <strong>Nome Completo</strong>
              </div>
              <div class="mr-n2">William "Billy" Batson</div>
              <div class="mr-2 mt-3">
                <strong>Codinomes conhecidos</strong>
              </div>
              <div class="mr-n2">Rei Shazam</div>
              <div class="mr-2 mt-3">
                ...
                <v-timeline :dense="$vuetify.breakpoint.smAndDown">
                  <v-timeline-item color="purple lighten-2" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="8">Família Shazam</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
