<template>
  <v-card class="mx-auto" max-width="344">
    <v-img src="../../assets/batman.png" max-height="460" max-width="400"></v-img>
    <v-card-title>Batman</v-card-title>
    <v-card-actions>
      <v-dialog transition="dialog-bottom-transition" max-width="600">
        ...
        <template v-slot:default="dialog">
          <v-card>
            <v-toolbar dark>Batman</v-toolbar>
            <v-card-text>
              <div class="mr-2 mt-3">
                <strong>Nome Completo</strong>
              </div>
              <div class="mr-n2">Bruce Thomas Wayne</div>
              <div class="mr-2 mt-3">
                <strong>Codinomes Conhecidos</strong>
              </div>
              <div class="mr-n2">
                Homem-Morcego, O Cavaleiro das Trevas, O Cruzado Encapuzado, O Detetive
                das Sombras, O Maior Detetive do Mundo
              </div>
              <div class="mr-2 mt-3">
                <strong>Terra Natal</strong>
              </div>
              <div class="mr-n2">Gotham City</div>
              <div class="mr-2 mt-3">
                ...
                <v-timeline :dense="$vuetify.breakpoint.smAndDown">
                  <v-timeline-item color="purple lighten-2" fill-dot right>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="8">Fundação Wayne</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
                  ...
                  <v-timeline-item color="red" fill-dot left small>
                    <v-card>
                      <v-container>
                        <v-row>
                          <v-col cols="12" md="10">Bat-Familia</v-col>
                        </v-row>
                      </v-container>
                    </v-card>
                  </v-timeline-item>
